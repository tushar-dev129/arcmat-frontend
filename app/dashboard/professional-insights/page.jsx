                ...
                <header className="mb-10">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
                        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-[13px] text-gray-400 font-bold uppercase tracking-wider">Total Designers</p>
                        ...
                        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-[13px] text-gray-400 font-bold uppercase tracking-wider">Total Orders</p>
