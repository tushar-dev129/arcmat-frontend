          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <button
                ...
                className="mt-1 flex items-center gap-1 text-[13px] text-gray-400 hover:text-primary transition-colors font-bold uppercase tracking-widest text-left"
              >
          ...
          <div className="flex items-center gap-3">
            <div className="relative group">
              <select
                ...
                className="appearance-none bg-white border border-primary/20 text-[#2d3142] text-[13px] font-bold rounded-xl px-5 py-3 pr-10 focus:outline-none focus:ring-4 focus:ring-orange-100 cursor-pointer transition-all shadow-sm group-hover:shadow-md uppercase tracking-widest"
              >
            ...
            <button
              ...
              className="px-6 py-3 bg-primary text-white text-[13px] font-bold rounded-xl hover:bg-[#c2896a] disabled:opacity-40 disabled:cursor-not-allowed transition-all active:scale-95 shadow-lg shadow-orange-200 flex items-center gap-2 uppercase tracking-widest"
            >
              {isPending ? (
                <>
