                    ...
                    <>
                        ...
                        <div className="relative flex items-center">
                            ...
                            <button
                                ...
                                className={`p-2 bg-white/80 backdrop-blur shadow-sm rounded-l-xl transition-all border-r border-gray-100
                                    ${hasContent
                                        ? 'text-gray-400 hover:text-green-500 hover:bg-green-50'
                                        : 'text-gray-200 cursor-not-allowed'}
                                    ${isExporting ? 'opacity-60 animate-pulse' : ''}`}
                                title={downloadTooltip}
                                aria-label="Download space as ZIP"
                            >
                                {isExporting ? (
                            ...
                            <button
                                ...
                                disabled={isExporting || isCSVExporting}
                                className={`p-2 bg-white/80 backdrop-blur shadow-sm rounded-r-xl transition-all
                                    ${hasContent
                                        ? 'text-gray-400 hover:text-blue-500 hover:bg-blue-50'
                                        : 'text-gray-200 cursor-not-allowed'}
                                    ${isCSVExporting ? 'opacity-60 animate-pulse' : ''}`}
                                title="Download CSV only"
                                aria-label="Download materials as CSV"
                            >
                                {isCSVExporting ? (
