...
export default function ProjectDiscussionTab({ projectId, projectName, moodboards = [] }) {
    ...
    return (
        <div className="flex flex-col h-[75vh] sm:h-[85vh] bg-white rounded-[24px] sm:rounded-[40px] border border-gray-100 overflow-hidden shadow-sm">
            {/* Header Section with Filters */}
            <div className="px-4 sm:px-8 pt-4 pb-1 border-b border-gray-100 bg-[#fef7f2]/50">
            ...
            <div
                ...
                className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 bg-gray-50/20 custom-scrollbar"
            >
                {isLoading ? (
            ...
            <div className="p-4 sm:p-6 bg-white border-t border-gray-100">
                <form onSubmit={handleSend} className="flex flex-col gap-3 sm:gap-4">
